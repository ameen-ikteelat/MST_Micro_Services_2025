...
public class OptionalExample {
	...
	public static void main(String[] args) {
		...
		List<Person> people = Arrays.asList(new Person(25, "Max"), new Person(30, "Sami"), new Person(22, "David"));
		...
		optionalPerson.ifPresentOrElse(person -> System.out.println("Person found: " + person),
	...
	private static Optional<Person> findPersonByName(List<Person> people, String name) {
		return people.stream().filter(person -> person.getName().equals(name)).findFirst();
	}
